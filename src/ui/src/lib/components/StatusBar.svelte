<script lang="ts">
  ...
  const isIndexingInProgress = $derived($appState.is_scanning && !$appState.is_fully_scanned);

  // Component-local handler for config changes
...
<div id="status-bar" class:indexing={isIndexingInProgress}>
  <details class="status-output-settings">
    <summary>
      <svg class="icon icon-closed" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M19 16v6" /><path d="M22 19l-3 3l-3 -3" /><path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
      </svg>
      <svg class="icon icon-opened" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M19 22v-6" /><path d="M22 19l-3 -3l-3 3" /><path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
      </svg>
      Output
    </summary>
