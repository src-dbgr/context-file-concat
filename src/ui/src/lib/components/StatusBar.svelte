<script lang="ts">
  ...
  const isIndexingInProgress = $derived(
    $appState.is_scanning && !$appState.is_fully_scanned
  );
  ...
  <details class="status-output-settings">
    <summary>
      ...
      >
        ...
        />
        <path d="M19 16v6" /><path d="M22 19l-3 3l-3 -3" /><path
      ...
      >
        ...
        />
        <path d="M19 22v-6" /><path d="M22 19l-3 -3l-3 3" /><path
          d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"
        />
      </svg>
      Output
