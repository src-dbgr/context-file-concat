...
<!--
  WICHTIG: Diese Komponente rendert IN das bestehende #preview-panel Element.
  Damit die Flex-Hierarchie unverändert bleibt, verwenden wir einen Wrapper
  mit display: contents (nimmt nicht am Layout teil).
-->
